      ...
      {addons.map((addon) => {
        ...
        return (
          <button
            ...
            className={`w-full flex items-center justify-between p-3 transition-colors ${!isSelectable ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
              }`}
          >
